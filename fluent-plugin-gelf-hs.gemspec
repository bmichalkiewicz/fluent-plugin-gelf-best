...
Gem::Specification.new do |spec|
  ...
  s.email          = ["bartosz.michalkiewicz@outlook.com"]

  s.summary     = "Sends Fluentd events Graylog2 by GELF"
  s.homepage    = "https://github.com/bmichalkiewicz/fluent-plugin-gelf-best"
